...
## Compare to original Landsat and Sentinel 2

```{python original_sentinel}
sentinel_catalog = pystac_client.Client.open(
    "https://earth-search.aws.element84.com/v0"
)
sentinel_stac_items = sentinel_catalog.search(
...
sentinel_cloud_free.squeeze(dim="time").sel(band=["red", "green", "blue"]).plot.imshow(
    rgb="band",
    robust=True,
    size=7,
    # vmin=0,
...
landsat_stac_items = landsat_catalog.search(
...
landsat_cloud_free.squeeze(dim="time").sel(band=["red", "green", "blue"]).plot.imshow(
    rgb="band",
    robust=True,
    size=7,
    # vmin=0,
